...
# in: integer > 1
# out: boolean IF prime? == TRUE
# what is a prime?
# a number that is not divisible by any number other than 1 or itself
# so I can take 2 upto the number - 1, and modulo the number divided by the current iteration
