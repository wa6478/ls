...
# - input: string
#   - words in the string are separated by one space
#   - all non-space chars are words
# - output: array of strings
#   - contains every word from the string
#     - append space and the word length to that word
    
# - algo
#   - split words
#   - call map on words
#   - return new string with word + ' #{word.length}'
