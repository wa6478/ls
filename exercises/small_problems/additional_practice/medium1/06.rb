...
# - input: a string of words that are "correct programs"
#   - correct programs means that each command or word in the string will correspond to some command or action within the language
#   - all numbers are integers (not floats)
# - output: no desired return value, goal is printing (side effect)

# - stack and register
#   - stack is LIFO (last in first out)
#   - operations that use a value from the stack, remove the value from the stack
#   - the result is stored in the register
#   - PRINT puts whatever is in the register
#   - PUSH adds whatever is in the register to the stack
#   - POP removes the topmost in the stack and puts it in the register
  
# - algo:
#   - intialize my register (as an integer)
#   - intialize my stack (as an array)
#   - split string as command array to iterate through
#   - iterate through the command string
#       - block will be a case statement that performs the operation and transformation of appropriate elements
